...
one-dimensional spectral distribution.  Fixed random signs symmetrize the
frequency samples.  The resulting frequencies form paired sine/cosine random
...
class SymmetrizedRealNVPSpectralKernel(gpytorch.kernels.Kernel):
    ...
    def frequencies(self) -> Tensor:
        """Return the fixed, sign-symmetrized training frequencies."""
